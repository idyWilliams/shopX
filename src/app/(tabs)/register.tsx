...
import { View, Text, TouchableOpacity, FlatList, StyleSheet, Dimensions, Pressable } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  productsSection: { flex: 2, padding: 16, borderRightWidth: 1, borderRightColor: '#27272a' },
  cartSection: { flex: 1, padding: 16, backgroundColor: '#18181b' },
