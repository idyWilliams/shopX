...
const GRID_ITEMS: GridItem[] = [
  ...
  { id: 'alerts', title: 'Alerts & Notifications', icon: 'bell', color: '#EF4444', screen: '/(tabs)/alerts', badge: 3 },
  { id: 'leads', title: 'Leads Tracker', icon: 'users', color: '#8B5CF6', screen: '/(tabs)/leads' },
  { id: 'staff', title: 'Staff & Attendants', icon: 'user-check', color: '#10B981', screen: '/(tabs)/settings/team' },
  { id: 'settings', title: 'Business Settings', icon: 'settings', color: '#6B7280', screen: '/(tabs)/settings' },
];
